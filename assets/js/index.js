...
const movieRenderLogic =(item)=> {
  const imgSrc = item.Poster==="N/A"?'https://images.unsplash.com/photo-1635805737707-575885ab0820?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80':item.Poster
...
const onMovieTemplate = (itemObj) => {
  const imgSrc =  itemObj.Poster==="N/A"?'https://images.unsplash.com/photo-1635805737707-575885ab0820?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80':itemObj.Poster
  return `
  <div
...
containerFunc(leftSec, movieRenderLogic)